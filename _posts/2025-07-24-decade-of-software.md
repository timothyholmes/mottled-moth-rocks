...
<ol class="footnotes">
    <li>
        ...
        <ul>
            ...
            <li>The backend is the code that runs on the server of an app's owner, and processes that data at the user's behest. Associated technologies in this post are NodeJS, PHP, Hapi, </li>
        </ul>
    </li>
    <li>
