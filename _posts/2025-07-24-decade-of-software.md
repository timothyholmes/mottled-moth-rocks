...
*Note: This is published, but I'm actively editing and updating it.*
...
I started this career by being curious and tinkering, without any foresight into where it may lead. I'm thankful that the craft is always evolving, and there's consistently some new development to learn. As I write this, I have an AI agent open in my text editor, the latest Those outside of the industry may not understand how quickly adopted and deeply ingrained AI tools have become in software development. For the most part the output of these tools has been good and steadily improving.

However we're in a strange time now, when every talking head in tech is sounding the alarm that junior engineers are being replaced with AI agents. After working with AI for some time, I am confident in saying that it's a fallacy to believe that any agent on the market can replace a software developer without oversight. But if productivity gains provided reduce the need for and raise the bar of what it means to be a junior dev, or misguided leadership opts to invest in AI tools rather than the next generation of programmers, I worry for the large swaths of folks entering tech based on the 2010s promise of guaranteed employment and good salaries. I certainly wonder if I'd have been able to make the cut long enough to acquire the skills I did in my junior roles that've allowed me to be productive further down the road.
